...
public class Lycanthrope {
    ...
    public Lycanthrope(Meute meute, String nom, int facteurImpetuosite, int niveau, char rangDomination, int facteurDomination, int force, String categorieAge, boolean sexe) {
        this.nom = nom;
        this.meute = meute;
